...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=SUBINYOUNAS\\SQLEXPRESS; Initial Catalog=TrainingManagmentSystem; Integrated security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CoursePurchase>(entity =>
            {
                entity.HasKey(e => e.AdmissionId)
                    .HasName("PK__coursePu__705A82596934F698");
            ...
            modelBuilder.Entity<Courses>(entity =>
            {
                entity.HasKey(e => e.CourseId)
                    .HasName("PK__courses__2AA84FD1962AEFC5");

                entity.ToTable("courses");

                entity.HasIndex(e => e.CourseName)
                    .HasName("UQ__courses__BEEA9EEC18A7EB51")
                    .IsUnique();
            ...
            modelBuilder.Entity<PageVisit>(entity =>
            {
                entity.HasKey(e => e.PageId)
                    .HasName("PK__pageVisi__54B1FF74C092E54E");
            ...
            modelBuilder.Entity<Resource>(entity =>
            {
                ...
                entity.HasIndex(e => e.ResourceName)
                    .HasName("UQ__resource__47AE2F638275F12C")
                    .IsUnique();
            ...
            modelBuilder.Entity<ResourcePurchase>(entity =>
            {
                entity.HasKey(e => e.PurchaseId)
                    .HasName("PK__resource__0261226C4FDD7D39");
            ...
            modelBuilder.Entity<Role>(entity =>
            {
                ...
                entity.HasIndex(e => e.Role1)
                    .HasName("UQ__role__863D2148F85071DD")
                    .IsUnique();
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__users__CB9A1CFF811A067C");
