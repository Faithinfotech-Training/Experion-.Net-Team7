...
const routes: Routes = [
  ...
  { path:'addcourse', component:AddCourcesComponent,canActivate:[AuthGuard],data:{role:'1'}},
  { path:'editcourse/:courseId', component:EditCourcesComponent,canActivate:[AuthGuard],data:{role:'1'} },
  ...
  {path:'editrpipeline/:id',component:EditResourcePipelineComponent,canActivate:[AuthGuard],data:{role:'1'}},
  ...
  { path: 'editcpipeline/:id', component: EditCoursePipelineComponent ,canActivate:[AuthGuard],data:{role:'1'}},
